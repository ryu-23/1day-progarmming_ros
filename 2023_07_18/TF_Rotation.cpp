...
void TF_base_link_base_link_map_inverse(Point2D base_link_Point2D, Point2D* base_link_map_point2d, Pose2D base_link_origin) // 2,3,4기

{
	double transformed_x_inverse = (Rotation_matrix_inverse[0][0] * base_link_map_point2d->x) + (Rotation_matrix_inverse[0][1] * base_link_map_point2d->y);
	double transformed_y_inverse = (Rotation_matrix_inverse[1][0] * base_link_map_point2d->x) + (Rotation_matrix_inverse[1][1] * base_link_map_point2d->y);
...
int _tmain(int argc, _TCHAR* argv[])
{
    ...
    base_link_map_Point2D.x = -0.707; //0.1;
	base_link_map_Point2D.y = 2.121;//0.1;
	...
	TF_base_link_base_link_map_inverse(base_link_Point2D, &base_link_map_Point2D, base_link_origin);
