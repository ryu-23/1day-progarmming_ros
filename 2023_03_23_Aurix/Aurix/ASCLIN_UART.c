...
void OUTPUT_GUI(void)
{
    for(int i = 0; i < 8 ; i++)
    {
        uart_buff[i] = uart_rx_buff[i] - 48;
    }

    (uart_buff[0] == 1) ?  IfxPort_setPinHigh(LED1) : IfxPort_setPinLow(LED1);
    (uart_buff[1] == 1) ?  IfxPort_setPinHigh(LED2) : IfxPort_setPinLow(LED2);
    (uart_buff[2] == 1) ?  IfxPort_setPinHigh(LED3) : IfxPort_setPinLow(LED3);
    (uart_buff[3] == 1) ?  IfxPort_setPinHigh(LED4) : IfxPort_setPinLow(LED4);
    (uart_buff[4] == 1) ?  IfxPort_setPinHigh(LED5) : IfxPort_setPinLow(LED5);
    (uart_buff[5] == 1) ?  IfxPort_setPinHigh(LED6) : IfxPort_setPinLow(LED6);
    (uart_buff[6] == 1) ?  IfxPort_setPinHigh(LED7) : IfxPort_setPinLow(LED7);
    (uart_buff[7] == 1) ?  IfxPort_setPinHigh(LED8) : IfxPort_setPinLow(LED8);
