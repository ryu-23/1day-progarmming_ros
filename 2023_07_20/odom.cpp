...
{
	encoder.data = encoder_data1.data;
}

void odometry_calculate(void)
{

	encoder.delta = encoder.data - encoder.data_old; //encoder 변화량
	ROS_INFO("encoder_delta : %d , encoder.data : %d , encoder.data_old : %d \n", encoder.delta, encoder.data, encoder.data_old);
