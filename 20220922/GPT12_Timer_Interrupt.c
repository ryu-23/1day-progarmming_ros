...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define ISR_PRIORITY_GPT12_TIMER_T3   8                     /* Define the GPT12 Timer interrupt priority            */
#define ISR_PRIORITY_GPT12_TIMER_T2   3         /* Interrupt provider                                   */
#define ISR_PRIORITY_GPT12_TIMER      IfxSrc_Tos_cpu0                 /* Reload value to have an interrupt each 500ms         */
#define RELOAD_VALUE                   48828u         /* LED which toggles in the Interrupt Service Routine   */
...
void initGpt12Timer(void)
{
    ...
    IfxSrc_init(src, ISR_PRIORITY_GPT12_TIMER, ISR_PRIORITY_GPT12_TIMER_T3);           /* Initialize service request   */
    IfxSrc_enable(src);

    volatile Ifx_SRC_SRCR *src_t2 = IfxGpt12_T2_getSrc(&MODULE_GPT120);                /* Get the interrupt address    */
    IfxSrc_init(src_t2, ISR_PRIORITY_GPT12_TIMER, ISR_PRIORITY_GPT12_TIMER_T2);           /* Initialize service request   */
