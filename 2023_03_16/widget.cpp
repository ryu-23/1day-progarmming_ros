...
void Widget::setTextDecimal(void) {
    ...
    QString myStr, myStr2;
       myStr+=ui->lineEdit_8->text();
       myStr+=ui->lineEdit_7->text();
       myStr+=ui->lineEdit_6->text();
       myStr+=ui->lineEdit_5->text();
       myStr+=ui->lineEdit_4->text();
       myStr+=ui->lineEdit_3->text();
       myStr+=ui->lineEdit_2->text();
       ...
       ui->INPUT_SEND_CHECK->setText(myStr2);
